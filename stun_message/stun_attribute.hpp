...
class StunAttribute {
public:
  AttributeTypeId get_type() const { return m_type_id; }
  ...
  StunAttribute() : m_type_id(AttributeTypeId::MappingAddress) {}
  explicit StunAttribute(AttributeTypeId type_id) : m_type_id(type_id) {}
  virtual ~StunAttribute() = default;
protected:
  AttributeTypeId m_type_id;
};
